...
MAPPING=(
  ...
  "the-bbc-and-the-sanctions-coverage=BBC_News"
  ...
  "kiriakou-titanium-knee=Knee_replacement"
  "the-minister-of-awqaf-compliment=Bahrain"
  "jesse-jackson=Jesse_Jackson"
  "the-african-diplomats-remark=China%E2%80%93Africa_relations"
  "another-bentley=Benazir_Bhutto"
  "the-national-guard-in-washington=District_of_Columbia_National_Guard"
  "democratic-change-in-the-middle-east=Arab_Spring"
  "the-libertarian-christmas-party=Old_Town,_Alexandria"
  "the-mi5-model=MI5"
  "the-university-of-salamanca-professorship=University_of_Salamanca"
  "every-israeli-i-ever-knew=Tel_Aviv"
  "saudi-influence-in-egypt=Egypt"
  ...
  "the-fifteen-minute-call=Federal_Correctional_Complex,_Terre_Haute"
  "pentagon-district-strategy=The_Pentagon"
  "refusal-to-talk-to-adversaries=George_W._Bush"
  "the-melber-walkout=Ari_Melber"
  "weapons-cache-map=Bunker"
  "the-nuclear-testing-legacy=Bikini_Atoll"
  "two-abu-zubaydahs=Abu_Zubaydah"
  "recruiting-from-the-bottom=Islamic_Revolutionary_Guard_Corps"
  ...
  "the-other-five-percent=Mossad"
  "arab-states-and-the-gaza-war=Rafah_Border_Crossing"
  "russian-illegals-program=Anna_Chapman"
  "grenada-invasion=Grenada_invasion"
  "the-rooftop-double-agent=Marriott_International"
  ...
  "spies-traded-home=Prisoner_exchange"
  "the-alcatraz-walkthrough=Alcatraz_Island"
  "the-legal-definition-of-whistleblowing=Whistleblower_Protection_Act"
  "stansfield-turner=Stansfield_Turner"
  "there-is-almost-no-upside=Federal_Correctional_Institution,_Loretto"
  "jerome-post=Jerrold_Post"
  "the-truman-broadcast=Harry_S._Truman"
  "cost-of-the-2026-iran-war=Axios_(website)"
  "prepublication-review=Redaction"
  ...
  "advanced-counterterrorism-operations-course=Counterterrorism"
  "prison-cell-transfers=Prison_cell"
  "the-sputnik-shutdown=Podcast"
  ...
  "the-caracas-checklist=Caracas"
  "the-pentagon-and-the-pakistani-arsenal=Pervez_Musharraf"
  "kiriakou-gun-rights-appeal=Firearm"
  "beyond-your-dreams=BYD_Auto"
  "the-fox-news-military-analyst=Fox_News"
  "elizabeth-rouser=Interview"
  "we-are-at-war-today=Counterterrorism_Center"
  "talk-liberation-bank-freeze=Reykjavik"
  "yves-engler-arrest=Montreal"
  "cia-psychological-evaluations=Psychiatry"
  ...
  "kiriakou-cipa-hearing=Classified_Information_Procedures_Act"
  "jihad-means-to-struggle=Jihad"
  "the-guard-booth-rounds=Prison_officer"
  "legal-mail=Envelope"
  "the-afghan-womans-lesson=Taliban"
  "too-much-work-to-be-mrs-kiriakou=Wedding_ring"
  ...
  "ireland-recognizes-palestine=Ireland"
  "the-cat-in-the-hat-and-truck=Federal_Correctional_Institution,_Loretto"
  "the-indicator-hed-be-watching=Aircraft_carrier"
  "the-job-in-the-medical-practice=Doctor's_office"
  "trilateral-commission=Trilateral_Commission"
  "i-had-no-intent=Alexandria,_Virginia"
  "the-prostitute-hypothetical=Lecture"
  "the-pezeshkian-invitation=Masoud_Pezeshkian"
  "drunken-border-guards=Border_guard"
  "make-it-the-blip=Alexandria,_Virginia"
  "pakistani-prisons=Imran_Khan"
  "home-confinement=Ankle_monitor"
  "college-tuition-as-an-inducement=Ivy_League"
  "general-intelligence-directorate=General_Intelligence_Directorate_(Jordan)"
  "the-qatari-seven-forty-seven=Boeing_747"
